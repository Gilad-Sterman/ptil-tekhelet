            ...
            <main className='main-layout eng'>
                ...
                <div className='card-container eng'>
                    <div className="card" id='card1'>
                        ...
                        <h4 className='eng'>This fabric is an archaeological find from Masada, dating back 2,000 years.
                            <br />
                            The fabric appears to be part of a robe or dress worn by a member of the Herodian royal family.
                            <br />Chemical analysis shows that the dye came from a Murex Trunculus snail.
                        </h4>
                    </div>
                    <div className="card" id='card2'>
                        ...
                        <h4 className='eng'>Emperor Nero was obsessed with the color from the snail!
                            <br />
                            ...
                            <br />When he saw a matron wearing a purple dress, he got so angry that he orderded his guards to strip her - of her clothes and all her possessions!
                        </h4>
                    </div>
                    ...
                    <div className="card" id='card18'>
                        ...
                        <h4 className='eng'>
                            <span className='bold'>"And now we have nothing but white, for Tekhelet has been lost" </span> (Tanhuma, Parashat Shlach, 15)                            <br />
                            <br />
